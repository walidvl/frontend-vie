        ...
        <div className="row">
          ...
          <div className="col-lg-8 valign">
            <div className="cont">
              ...
              Welcome, {userName}! Embark on your German learning journey with our innovative methods.
                  ...
                  <Typewriter
                    options={{
                      ...
                      strings: [
                        ...
                        "Strategies Tailored for Exam Success",
                  ...
                  <div className="flex">
                    <div className="text valign">
                      <div className="full-width">
                        <p>Get In Touch</p>
                        <h6>Contact.deutschlearninghub@gmail.com</h6>
                      </div>
                    </div>
